...
<head>
    ...
    <link rel="stylesheet" href="{{asset('user/layui/css/layui.css')}}"/>
    <link rel="stylesheet" href="{{asset('user/css/gloable.css')}}"/>
    <link rel="stylesheet" href="{{asset('user/css/nprogress.css')}}"/>
                    ...
                    <section class="article-item zoomIn article">
                        ...
                        <div class="content">
                            <a href="read.html" class="cover img-light">
                                <img src="/user/image/cover/2019121192339714.png">
                            </a>
