...
<div id="navgation" class="navgation navgation_close">
    <ul class="point">
        <li><a href="#">首页</a></li>
        <li><a href="{{url('article')}}">博客</a></li>
        <li><a href="{{url('diary')}}">日记</a></li>
    ...
    <div class="fp-tablecell">
        <div class="page4">
            <div class="warp-box">
                <div class="about">
                    <div class="inner">
                        <h1 class="wow fadeInLeft">水水水水</h1>
            ...
            <div class="layui-row">
                ...
                <div class="layui-col-xs12 layui-col-sm12 layui-col-md4">
                    <div class="single-widget contact">
                        <h2>联系我</h2>
                        <ul class="list">
                            <li><i class="fa fa-map"></i>地址: 重庆市黔江区太极乡</li>
                            <li><i class="fa fa-qq"></i>QQ: 309300232 </li>
                            <li><i class="fa fa-envelope"></i>邮箱: 309300232@qq.com</li>
                        </ul>
                    </div>
                </div>
            </div>
