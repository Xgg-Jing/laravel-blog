                    ...
                    <div class="layui-card">
                        <div class="layui-card-body ">
                            <form class="layui-form layui-col-space5" method="get" action="{{url('admin/user')}}">
                                ...
                                <div class="layui-inline layui-show-xs-block">
                                    <input class="layui-input"  autocomplete="off" placeholder="请输入用户名" name="username" class="layui-input" value="{{$request->username}}">
                                </div>
                                <div class="layui-inline layui-show-xs-block">
                                    <input type="text" name="email"  placeholder="请输入邮箱" autocomplete="off" class="layui-input" value="{{$request->email}}">
                                </div>
                                <div class="layui-inline layui-show-xs-block">
